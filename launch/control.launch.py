...
def launch_setup(context, *args, **kwargs):
    ...
    lat_controller_param_path = os.path.join(
        LaunchConfiguration("carla_control_launch_param_path").perform(context),
        "trajectory_follower",
...
def generate_launch_description():
    ...
    # parameter
    add_launch_arg(
        "carla_control_launch_param_path",
        [
            FindPackageShare("carla_control_launch"),
            "/config",
        ],
        "carla_control_launch parameter path",
    )
